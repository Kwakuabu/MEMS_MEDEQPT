...
<head>
    ...
    <title>Overall In-charge Dashboard</title>
</head>
<body>
    ...
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <ul>
                ...
                <li><a href="{{ route('incharge.departments') }}">Manage De</a></li>
        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <p>Manage department details, assign rotations, and oversee department structures.</p>
                <ul>
                    <li><a href="{{ route('incharge.departments') }}" class="btn btn-primary">View Departments</a></li>
                    <li><a href="{{ route('incharge.manage-rotations') }}" class="btn btn-secondary">Manage Rotations</a></li>
                </ul>
            </div>
        </div>
    </div>
