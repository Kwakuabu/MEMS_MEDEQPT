...
<body>
    ...
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <ul>
                <li><a href="{{ route('technician.dashboard') }}">Dashboard</a></li>
                <li><a href="{{ route('technician.workorders') }}">Work Orders</a></li>
                <li><a href="{{ route('technician.activitylogs') }}">Activity Logging</a></li>
                <li>
                    <a href="{{ route('logout') }}" 
        ...
        <div class="main-content">
            ...
            <div class="card">
                <h2>Team Members in Your Department</h2>
                <ul>
                    @if($members->isEmpty())
                        <li>No team members found in your department.</li>
                    @else
