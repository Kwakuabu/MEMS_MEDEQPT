        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <table style="width: 100%; margin-top: 1rem; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid var(--gray200); padding: 0.5rem; text-align: left;">Machine Description</th>
                            <th style="border: 1px solid var(--gray200); padding: 0.5rem; text-align: left;">Quantity</th>
                            <th style="border: 1px solid var(--gray200); padding: 0.5rem; text-align: left;">Brand Name</th>
                            <th style="border: 1px solid var(--gray200); padding: 0.5rem; text-align: left;">Model</th>
                            <th style="border: 1px solid var(--gray200); padding: 0.5rem; text-align: left;">Serial Number</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($equipment->isEmpty())
                            <tr>
                                <td colspan="5" style="text-align: center; padding: 1rem;">No equipment found in your department.</td>
                            </tr>
                        @else
                            @foreach($equipment as $item)
                                <tr>
                                    <td style="border: 1px solid var(--gray200); padding: 0.5rem;">{{ $item->machine_description }}</td>
                                    <td style="border: 1px solid var(--gray200); padding: 0.5rem;">{{ $item->quantity }}</td>
                                    <td style="border: 1px solid var(--gray200); padding: 0.5rem;">{{ $item->brand_name }}</td>
                                    <td style="border: 1px solid var(--gray200); padding: 0.5rem;">{{ $item->model }}</td>
                                    <td style="border: 1px solid var(--gray200); padding: 0.5rem;">{{ $item->serial_number }}</td>
                                </tr>
                            @endforeach
                        @endif
                    </tbody>
