...
<head>
    ...
    <style>
        ...
        *:after {
        ...
        .card ul li {
            list-style: none;
            flex: 1; /* Make each list item (button) take equal space */
        }
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="card">
                <h2>Rotation Management</h2>
                <p>Manage the rotations of department members and oversee their assignment to various departments.</p>

                <!-- Display available rotation actions side by side -->
                <ul>
                    <li><a href="{{ route('incharge.manage-rotations') }}">View Current Rotations</a></li>
                    <!-- Ensure department data is available in the view -->
